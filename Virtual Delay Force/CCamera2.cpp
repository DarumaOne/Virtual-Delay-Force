...
*/
//===========================================================================
void cCamera::renderView(const int a_windowWidth, const int a_windowHeight, OVR::Matrix4f projectionMatrici, ovrPosef eyePoses, ovrVector3f	cameraPosition, 
